<?php 
	...
	if (isset($_POST['btnsubmit'])) 
	{
		...
		{
			$insert="INSERT INTO User(FirstName,LastName,Phone,UserEmail,Password,Address,DOB,Gender)
					VALUES('$fname','$sname','$phone','$email','$password','$address','$dob','$gender')";
			...
			{
				echo "<p>Error in User Registeration Page: ".mysqli_error($connection)."</p>";
			}
		}
	}
?>
			...
			<fieldset>
				...
				<table align="center" cellspacing="3">
					...
					<tr>
						<td>Password</td>
						<td>
							<input type="password" name="txtpasswrod" placeholder="XXXXXXXX" required>
						</td>
					</tr>
					<tr>
						<td>Address</td>
