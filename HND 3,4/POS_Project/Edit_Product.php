...
<body>
	<form action="Edit_Product.php" method="POST">
		<table align="center" cellpadding="5">
				<tr>
					<td>Product ID</td>
					<td><input type="text" name="txtproductid" value="<?php echo $arr['ProductID']; ?>" required></td>
				</tr>
				<tr>
					<td>Description:</td>
					<td><input type="text" name="txtdescription" value="<?php echo $arr['Description']; ?>" required></td>
				</tr>
				<tr>
					<td>Price:</td>
					<td><input type="text" name="txtprice" value="<?php echo $arr['Price']; ?>" required></td>
				</tr>
				<tr>
					<td>Color:</td>
					<td><input type="text" name="txtcolor" value="<?php echo $arr['Color']; ?>" required></td>
				</tr>
				<tr>
					<td>Size:</td>
					<td><input type="text" name="txtsize" value="<?php echo $arr['Size']; ?>" required></td>
				</tr>
				<tr>
					<td>Path:</td>
