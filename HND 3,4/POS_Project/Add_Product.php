 <?php 
	...
	if (isset($_POST['btnsave'])) {
		...
		$checkproduct="SELECT * FROM Product
				WHERE ProductID='$pid'";
		$ret=mysqli_query($connection,$checkproduct);
	...
	<fieldset>
		...
		<form action="Add_Product.php" method="post" enctype="multipart/form-data">
			<table align="center" cellpadding="5">
				<tr>
					<td>Product ID</td>
					<td><input type="text" name="txtproductid" value="<?php echo AutoID('Product','ProductID','P-',6); ?>" required></td>
				</tr>
				<tr>
					<td>Description:</td>
					<td><input type="text" name="txtdescription" placeholder="Enter Product Description" required></td>
				</tr>
				<tr>
					<td>Price:</td>
					<td><input type="text" name="txtprice" placeholder="Enter Product Price" required></td>
				</tr>
				<tr>
					<td>Color:</td>
					<td><input type="text" name="txtcolor" placeholder="Enter Product Color" required></td>
				</tr>
				<tr>
					<td>Size:</td>
					<td><input type="text" name="txtsize" placeholder="Enter Product Size" required></td>
				</tr>
				<tr>
					<td>Path:</td>
				...
				<tr>
					<td>Quantity:</td>
					<td><input type="text" name="txtquantity" placeholder="Enter Product Quantity" required></td>
				</tr>
				<tr>
					<td>Brand:</td>
					<td>
							...
							<?php 
								...
								if ($num_results==0) {
									...
									for ($i=0; $i < $num_results; $i++) {
										...
										echo "<td><a href='Edit_Product.php?ProductID=$ProductID&Mode=Update'>Edit</a>|<a href='DeleteProduct.php?ProductID=$ProductID'>Delete</a></td>";
										echo "</tr>";
									}
